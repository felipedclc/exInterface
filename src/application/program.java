...
public class program {
	...
	public static void main(String[] args) throws ParseException {
		...
		RentalService rentalServ = new RentalService(pricePerDay, pricePerHour, new BrazilTaxService());
		
		rentalServ.processInvoice(carRent); 
		...
		System.out.println("Total payment: " + String.format("%.2f", carRent.getInvoice().getTotalPaymet()));
